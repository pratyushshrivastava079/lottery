...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$chck_status = "SELECT * FROM `checkbox_status` WHERE `type` = '2dbetform' AND `stage` = '2'";
...
// 
				...
				// echo "txt2d is ".$txt2d;
					...
					$query= "INSERT INTO 2dbetform( `user_id`, `order_id`, `2dtxt`, `usd`, `khr`, `radiobox`, `checklevel`, `stage`, `type` ) VALUES( '$userid', '$order_id', '$txt2d', '$usd', '$khr', '$radio', '$checkboxlevel', '2', '2dbetform' )";
						// print_r($query);
						// die();
						$order = array();
					...
					for($j = 0; $j < $incrementval; $j++){
						...
						$query= "INSERT INTO 2dbetform( `user_id`, `order_id`, `2dtxt`, `usd`, `khr`, `radiobox`, `checklevel`, `stage`, `type` ) VALUES( '$userid', '$order_id', '$newtxt2d[$j]', '$usd', '$khr', '$radio', '$checkboxlevel', '2', '2dbetform' )";
						// print_r($query);
						// die();
						$order = array();
	...
	<div class="container">
		...
		<section>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<form action="2d2-betform.php" method="POST">
			            ...
			            <div class="checkbox">
			            	...
			            	<?php foreach ($chck_users as $key => $value) {
			            		...
			            		if($value['status'] == 1){
			            			...
			            			if($value['checkbox'] == 'K' || $value['checkbox'] == 'O' || $value['checkbox'] == 'L 23' || $value['checkbox'] == 'L 25' || $value['checkbox'] == 'L 27' || $value['checkbox'] == 'L 29'){
	                	...
	                	<?php foreach ($chck_users as $key => $value) {
			            		...
			            		if($value['status'] == 1){
			            			...
			            			if($value['checkbox'] == 'A' || $value['checkbox'] == 'B' || $value['checkbox'] == 'C' || $value['checkbox'] == 'D' || $value['checkbox'] == 'H' || $value['checkbox'] == 'I' || $value['checkbox'] == 'N' || $value['checkbox'] == 'K' || $value['checkbox'] == 'O'  ){
				            			...
				            			if($value['checkbox'] == 'L 23'){

				            				$id = 'L23';
				            			
				            			}elseif($value['checkbox'] == 'L 25'){

				            				$id = 'L25';

				            			}elseif($value['checkbox'] == 'L 27'){

				            				$id = 'L27';
				            			
				            			}elseif($value['checkbox'] == 'L 29'){
			                ...
			                <?php foreach ($chck_users as $key => $value) {
			            		...
			            		if($value['status'] == 1){
			            			...
			            			if($value['checkbox'] == 'A' || $value['checkbox'] == 'B' || $value['checkbox'] == 'C' || $value['checkbox'] == 'D' || $value['checkbox'] == 'H' || $value['checkbox'] == 'I' || $value['checkbox'] == 'N' || $value['checkbox'] == 'L 23' || $value['checkbox'] == 'L 25' || $value['checkbox'] == 'L 27' || $value['checkbox'] == 'L 29'){
