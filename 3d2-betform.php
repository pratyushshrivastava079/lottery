...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$chck_status = "SELECT * FROM `checkbox_status` WHERE `type` = '3dbetform' AND `stage` = '2'";
...
// 
				...
				// echo "txt3d is ".$txt3d;
					...
					$query= "INSERT INTO 2dbetform( `user_id`, `order_id`, `2dtxt`, `usd`, `khr`, `radiobox`, `checklevel`, `stage`, `type` ) VALUES( '$userid', '$order_id', '$txt3d', '$usd', '$khr', '$radio', '$checkboxlevel', '2', '3dbetform' )";
						// print_r($query);
						// die();
						$order = array();
				...
				// 						$finalvaluekhr = ( $khr[$j]  * $countcheckorder ) + ( $khr[$j] * 22 );
						...
						$query= "INSERT INTO 2dbetform( `user_id`, `order_id`, `2dtxt`, `usd`, `khr`, `radiobox`, `checklevel`, `stage`, `type`, `totalusd`, `totalkhr` ) VALUES( '$userid', '$order_id', '$newtxt3d[$j]', '$usd', '$khr', '$radio', '$checkboxlevel', '2', '3dbetform', '$finalvalueusd', '$finalvaluekhr' )";
			...
			if($radio != ""){
				...
				for($j = 0 ; $j < $counttxt3d; $j++ ){								
					...
					// 		);
							...
							$query= "INSERT INTO 2dbetform( `user_id`, `order_id`, `2dtxt`, `usd`, `khr`, `radiobox`, `checklevel`, `stage`, `type`, `totalusd`, `totalkhr` ) VALUES( '$userid', '$order_id', '$txt3d[$j]', '$usd[$j]', '$khr[$j]', '$radio', '$checkboxlevel', '2', '3dbetform', '$finalvalueusd', '$finalvaluekhr' )";
							// print_r($query);
							// die();
							$order = array();
	...
	<div class="container">
		...
		<section>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<form action="3d2-betform.php" method="POST" id="3dform">
              
            		<input type="hidden" id="lastStage" value="1" />

                	<div class="card-header"><h3 id="Stage" data-Stage="1">Stage 2</h3></div>
		            ...
		            <div class="radio">
		                ...
		                <label class="radio-inline"><input type="radio" name="optradio" value="5R">10 S</label>
		            ...
		            <div class="checkbox lower">
              		...
              		<button type="button" class="btn btn-default"><a href="3d2-betform.php">Reset</a></button>
